...
namespace LTQLQLCH.Controllers
{
    public class HoaDonsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaHD,ThanhTien,KhachHang_MaKH")] HoaDon hoaDon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaHD,ThanhTien,KhachHang_MaKH")] HoaDon hoaDon)
        {
            if (ModelState.IsValid)
            {
