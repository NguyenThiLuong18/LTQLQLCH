...
namespace LTQLQLCH.Controllers
{
    public class PhieuNhapsController : Controller
    {
        ...
        {
            ViewBag.NhaCC_MaNCC = new SelectList(db.NhaCCs, "MaNCC", "TenNCC");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "MaPN,NgayTao,NhaCC_MaNCC")] PhieuNhap phieuNhap)
        {
            ...
            ViewBag.NhaCC_MaNCC = new SelectList(db.NhaCCs, "MaNCC", "TenNCC", phieuNhap.NhaCC_MaNCC);
            return View(phieuNhap);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaPN,NgayTao,NhaCC_MaNCC")] PhieuNhap phieuNhap)
        {
            if (ModelState.IsValid)
            {
